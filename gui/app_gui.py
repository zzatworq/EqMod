...
class LatexClipboardApp:
    ...
    def create_gui(self):
        ...
        self.mode_var = tk.StringVar(value="Matplotlib")
        modes = ["Matplotlib", "Standalone"]
        self.mode_menu = ttk.OptionMenu(settings_frame, self.mode_var, "Matplotlib", *modes)
        ...
        self.color_menu = ttk.OptionMenu(settings_frame, self.color_var, "white", *colors)
